                 ...
                 <div class="mb-4">
                    <h6 class="text-uppercase fw-bold text-muted mb-3">Informasi Pemesan</h6>
                     <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="border rounded p-3 bg-light">
                                <strong>Tanggal Order:</strong><br>{{ $order->created_at->format('d M Y H:i') }}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="border rounded p-3 bg-light">
                        ...
                        <div class="col-md-4">
                            <div class="border rounded p-3 bg-light">
                                ...
                                <span class="badge {{ $order->status == 'pending' ? 'bg-warning text-dark' : ($order->status == 'success' ?'bg-success' : 'bg-danger') }}">
