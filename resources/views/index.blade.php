                                        ...
                                        <div class="grid__wraper__img">
                                            ...
                                            <div class="grid__wraper__icon">                                
                                                <ul>
                                                    ...
                                                    <li>
                                                        <a href="{{ route('cart.add', $data->id) }}" onclick="event.preventDefault(); document.getElementById('add-to-cart-form-{{ $data->id }}').submit();" data-bs-toggle="tooltip"  data-bs-placement="top" title="Add To Cart" data-bs-original-title="Add To Cart">
...
<div class="grid__quick__view__modal modalarea modal fade" id="productModal-{{ $data->slug }}" tabindex="-1" aria-labelledby="productModal" aria-hidden="true">
